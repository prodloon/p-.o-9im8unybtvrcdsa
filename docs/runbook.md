...
node backend/backend.selftest.js       # 164 checks (incl. S16 orphan-guard, S17 log-parser, S18 supervisor-root, S20 key-health, S21 confidence-escalation, S22 t2-canary suites)
